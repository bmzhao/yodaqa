...
public class AF {
	...
	/** Answer Feature: 1 if the origin of this answer is the custom kb properties */
	public static final String OriginCustomProperty = "originCustomProperty";
	/** Answer Feature: Negative evidence set to -1 if the origin
	 * of this answer is a custom kb property that does not
	 * match any question clue in its label. */
	public static final String OriginCustomPNoClue = "originCustomPNoClue";
	/** 1 if the origin of this answer is a custom kb
	 * property with a clue matching a word in the property name.
	 * A set of features with autogenerated names, e.g.
	 * "originDBpPClueToken". */
	public static final String OriginCustomP_ClueType = "originCustomP" /* + clue.getShortName() or AF._clueType_* */;
	...
	/** Answer Feature: Boolean value whether we generated a LAT that
	 * is a custom property name. */
	public static final String LATCustomProperty = "LATCustomProperty";
