...
public class AnswerFV {
	...
	public static String labels[] = {
		...
		"originCustomProperty", "originCustomPNoClue",
			"originCustomPClueToken", "originCustomPCluePhrase", "originCustomPClueSV",
			"originCustomPClueNE", "originCustomPClueLAT",
			"originCustomPClueSubject", "originCustomPClueSubjectNE",
			"originCustomPClueSubjectToken", "originCustomPClueSubjectPhrase",
			"originCustomPClueNgram", "originCustomPClueConcept",
			"originCustomPConceptSourceRR", "originCustomPConceptLabelRR", "originCustomPConceptScore",
